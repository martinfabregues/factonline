...
<div class="page-title">
    <div class="title_left">
        <h3>Productos <small> Productos Registrados</small></h3>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel" style="height:800px;">
            ...
            <div class="x-content">
                ...
                <span class="row">
                    <a href="{{ URL::to('productos/create') }}" class="btn btn-primary btn-sm pull-right"><span class="glyphicon glyphicon-plus"></span> Nuevo Producto</a>
                </span>
